...
class BinanceFuturesClient:
    ...
    def _make_request(self, method: str, endpoint: str, data: typing.Dict):
        if method == 'GET':
            try:
                ...
                logger.error("Connection error while making %s to %s: %s", method, endpoint, e)
                return None
        elif method == 'POST':
            try:
        ...
        if response.status_code == 200:
            ...
            logger.error("Error while making request %s request to %s: %s (error code %s)",
    ...
    def get_historical_candles(self, contract: Contract, interval: str) -> typing.List[Candle]:
        ...
        if raw_candles is not None:
            for candle in raw_candles:
                candles.append(Candle(candle, "binance"))

        print(candles[0].close)
    ...
    def place_oder(self, contract: Contract, side: str, quantity: float, order_type: str, price=None,
    ...
    def subscribe_channel(self, contracts: typing.List[Contract], channel: str):
        ...
        # data['params'].append(contract.symbol.lower() + "@bookTicker") < - bookTicker is a channel
        # data['params'].append(symbol.lower() + "@markPrice")
